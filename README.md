...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/607ff87320ad2d001962d1ed
...
To start editing your site, you can use the Sanity interface at https://famous-thyme-ff873.sanity.studio/.
...
Generated at `2021-04-21T10:03:50.333Z` by Stackbit version `0.3.50`.